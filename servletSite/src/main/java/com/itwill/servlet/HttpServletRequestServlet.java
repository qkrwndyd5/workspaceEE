...
public class HttpServletRequestServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	  ...
	  2.POST 요청방식 : request.do  
		...
		out.println("<li>요청메쏘드:"+requestURL+"</li>");
		out.println("<li>요청메쏘드:"+requestURI+"</li>");
		...
		System.out.println("<li>phone 파라메타값:"+phone+"</li>");
		System.out.println("<li>address 파라메타값:"+address+"</li>");
		out.println("</ol>");
	}
