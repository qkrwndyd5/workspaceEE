		...
		public void init(ServletConfig config) throws ServletException {			
			...
			try {
				...
				*/
				...
				System.out.println("----------설정파일["+configFile+"]을 이용해서 Controller객체생성---------");
				while (commandKeyIterator.hasNext()) {
					 ...
					 * Controller클래스 이름을 사용해서 Controller객체생성
					...
					//System.out.println(command+"-->"+controllerMappingProperties.getProperty(command));
				}
				System.out.println("----------------------------------------------------------------------------");
