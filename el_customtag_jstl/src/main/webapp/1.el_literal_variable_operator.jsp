...
<%
	...
	pageContext.setAttribute("string2", "주용");
	...
	pageContext.setAttribute("weight", 77);
	pageContext.setAttribute("height", 175);
...
<body>
	...
	<ul>
		...
		<li>${23 * 56}</li>
		<li>${1 / 3}</li>
		<li>${(1+2)-89/(34+48)*0.2}</li>
		<li>${int1 + int2}</li>
		<li>${int1 - int2}</li>
		<li>${int1 * int2}</li>
		<li>${int1 / int2}</li>
		<li>${double1 / double1 + 0.2351484}</li>
		<%-- 
