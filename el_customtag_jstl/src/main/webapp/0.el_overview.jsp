...
<%
	...
	/***********[2] 자바빈 속성객체*************************/
	request.setAttribute("guest", new Guest(1,"KIM","2023/02/","hello@naver.com","http://www.itwill.com","타이틀","컨텐트"));
	request.setAttribute("user", new User("PARK","1111","파악","park@gmail.com"));
	
	/***********[3] List(array)속성객체*********************/
	List<Guest> guestList = new ArrayList<Guest>();
	guestList.add(new Guest(1,"KIM","2023/02","guest1@naver.com","gttp://itwill.com","타이틀1","컨텐트1"));
	guestList.add(new Guest(2,"SIM","2023/03","guest2@naver.com","gttp://itwill.com","타이틀2","컨텐트2"));
	guestList.add(new Guest(3,"BIM","2023/04","guest3@naver.com","gttp://itwill.com","타이틀3","컨텐트3"));
	request.setAttribute("guestList", guestList);
	
	/***********[4] Map 속성객체****************************/
	Map<String, User> userMap = new HashMap<String,User>();
	userMap.put("guard1", new User("guard1","1111","가드1","guard1@naver.com"));
	userMap.put("guard2", new User("guard2","2222","가드2","guard2@naver.com"));
	userMap.put("guard3", new User("guard3","3333","가드3","guard3@naver.com"));
	request.setAttribute("userMap", userMap);
	
	/***********[5] JSP service안에선언된 local변수*********/
	String str1="난 JSP로컬변수";
	int int1=1234;
	User user1 = new User("KING","1111","와앙","king1@naver.com");
